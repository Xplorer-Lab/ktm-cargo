-- P0-3b: process_refund_atomic
-- Replaces the client-side read-then-write in InvoiceService.processRefund()
-- with a locked DB transaction so concurrent payment+refund cannot corrupt
...
BEGIN
  ...
  -- Full refund: balance_due = 0 (money returned, nothing owed)
  -- Partial refund: balance_due = total_amount - new amount_paid
