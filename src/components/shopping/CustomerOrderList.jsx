...
import { Users, Link, AlertTriangle, DollarSign, Weight, ShoppingBag, Plus, Eye, Pencil, Trash2 } from 'lucide-react';
                                ...
                                <div className="p-2 bg-blue-50 rounded-lg mb-3 text-xs">
                                    ...
                                    <div className="flex items-center justify-between mt-1">
                                        ...
                                        <Button
                                            size="sm"
                                            variant="ghost"
                                            className={`h-6 px-2 text-[10px] uppercase font-bold tracking-wider rounded border ${order.vendor_payment_status === 'PAID'
                                                    ? 'bg-emerald-100 text-emerald-700 border-emerald-200 hover:bg-emerald-200'
                                                    : 'bg-slate-100 text-slate-500 border-slate-200 hover:bg-slate-200'
                                                }`}
                                            onClick={(e) => onToggleVendorPayment(order, order.vendor_payment_status !== 'PAID', e)}
                                        >
