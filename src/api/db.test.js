...
describe('createEntityClient', () => {
    ...
    beforeEach(() => {
        ...
        mockQueryBuilder = {
            select: mockSelect,
            insert: jest.fn().mockReturnValue({ select: jest.fn().mockReturnValue({ single: jest.fn().mockReturnValue({ then: mockThen }) }) }),
            update: jest.fn().mockReturnValue({ eq: jest.fn().mockReturnValue({ select: jest.fn().mockReturnValue({ single: jest.fn().mockReturnValue({ then: mockThen }) }) }) }),
    ...
    test('create() selects specific fields', async () => {
        ...
        const mockInsertSelect = jest.fn().mockReturnValue({ single: jest.fn().mockReturnValue({ then: jest.fn((r) => r({ data: {}, error: null })) }) });
    ...
    test('update() selects specific fields', async () => {
        const mockUpdateSelect = jest.fn().mockReturnValue({ single: jest.fn().mockReturnValue({ then: jest.fn((r) => r({ data: {}, error: null })) }) });
